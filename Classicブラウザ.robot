    ...
    <steps class="ArrayList">
      <object class="Transition" serializationversion="3" id="4">
        ...
        <property name="stepAction" class="LoadPage2">
          ...
          <property name="browserConfigurationSpecification" class="kapow.robot.plugin.common.support.browser2.BrowserConfigurationSpecificationClassic" serializationversion="26">
